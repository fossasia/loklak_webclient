...
function MapPopUpTemplateService($filter) {
  ...
  service.startupInfoPopUp = function(status) {
    ...
    result = '<h4>' + title + '</h4>'
            ...
            +       '<div class="bottom-content">'
            +            '<div class="user-no-tweets">'
            +               '<a href=""><i class="fa fa-map-marker fa"></i><br><span><a href='+status.company_url+'>'+status.location+'</a></span></a>'
            +            '</div>'
            +            '<div class="user-no-followings">'
            +                '<a href=""><i class="fa fa-globe fa"></i><br><span><a href='+status.company_url+'>Website</a></span></a>'
            +            '</div>'
            +            '<div class="user-no-followers">'
