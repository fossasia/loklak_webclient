...
controllersModule.controller('AnalyzeCtrl', ['$rootScope','$http','$scope','AppSettings', 
function($rootScope,$http,$scope,AppSettings) {
console.log($rootScope.root);    
    ...
    $scope.getstatfollower = function () {
        ...
        // Using loklak.org for now as locally does not return anything
        $http.jsonp("http://loklak.org/api/user.json?callback=JSON_CALLBACK", 
        { params : 
            { screen_name : $scope.username, 
                followers : 10000, 
                following : 10000, 
                 minified : true 
             } 
    ...
    $rootScope.$watch(function(){
        return $rootScope.root.isLoggedIn;
    },  function(newVal){
